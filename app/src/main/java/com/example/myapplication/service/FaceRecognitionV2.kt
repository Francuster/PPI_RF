...
public fun addFace(inputImage: Bitmap,label: String, context: Context){
    ...
    knownEmbeddingsList.plus(recognizedFaceEmbeddings)
    labelsList.plus(label)

}

public fun faceRecognition(inputImage: Bitmap, context: Context): String {
...
fun loadModelFile(modelPath: String, context: Context): MappedByteBuffer {
    return FileUtil.loadMappedFile(context!!,"mobile_face_net.tflite")
}

// Function to preprocess the input image
fun preprocessImage(inputImage: Bitmap): ByteBuffer {
...
fun matchFaceEmbeddings(embeddings: FloatArray): String {
...
fun calculateCosineSimilarity(embeddings1: FloatArray, embeddings2: FloatArray): Float {
    var dotProduct = 0.0
    var norm1 = 0.0
    var norm2 = 0.0
